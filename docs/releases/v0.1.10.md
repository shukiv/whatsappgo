...
A small follow-up to v0.1.9. It repairs photo panning, aligns contact names the
same way whatever script they are written in, and states the account risk of
using an unofficial client plainly. It does not imply full WhatsApp feature
parity.

## Highlights

- A zoomed photo can no longer be dragged off its own edge into empty space.
- A contact name in Hebrew or Arabic starts beside the avatar, where a name in
  Latin script already did.
- The README, the security document and the bot API reference now say that
  using this client breaches WhatsApp's Terms of Service, that enforcement
  lands on the phone number, and which behaviours draw a ban.
