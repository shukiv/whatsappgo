...
if command -v pkg-config >/dev/null 2>&1; then
    for module in Qt6Core Qt6Gui Qt6Quick Qt6Network Qt6Multimedia Qt6Svg; do
...
case "${ID:-}" in
    ...
    fedora|rhel|centos)
        ...
        ;;
    arch|manjaro)
        install_hint="sudo pacman -S --needed base-devel cmake ninja pkgconf qt6-base qt6-declarative qt6-multimedia qt6-svg qqc2-desktop-style"
        ;;
    *)
        install_hint="Install CMake, a C++ compiler, pkg-config, and the Qt 6 Base/Declarative/Multimedia/SVG development files."
        ;;
esac
